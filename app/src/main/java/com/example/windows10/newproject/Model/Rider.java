...
public class Rider {
    ...
    public Rider(String name, String gender, String contact, String city, String email, String DOB, String password, String guardianName, String guardianWho, String guardianContact) {
        this.name = name;
        this.gender = gender;
